...
<body>
	<div class="color-overlay">
		<video autoplay loop muted id=few>
			<source src="fanta.mov" type="video/mp4">
		</video>
	</div>
	...
	<div class="container movie-detail">
		<div class="row">
			<div class="col-md-6 left-box">
				...
				<form action="se_movie_db.php" method="post">
					...
					<?php endif ?>
					<br><br><br><input type="checkbox" id="ve" name="m_ID" value="5" required>&nbsp;Please agree to confirm to buy tickets.
			...
			<div class="col-md-6 text-center">
				<img src="image-movie/m-20.png" class="movie-img">
				<div class="overlay">
					<a href="https://www.youtube.com/watch?v=ViuDsy7yb8M" class="icon" title="Play">
		...
		<div class="col-md-6 series">
			...
			<div class="popular-movies">
				<img src="image-movie/ha1.png">
				<img src="image-movie/ha2.png">
				<img src="image-movie/ha3.png">
				<img src="image-movie/ha4.png">
				<img src="image-movie/ha5.png">
				<img src="image-movie/ha6.png">
			</div>
		</div>
...
<style>
	body {
		background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(image-movie/background13.png);
